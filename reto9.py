...
El usuario introduce un número N, que indica el número de días que quiere ver, se deberá imprimir el número del 
día, si no tienen nada en esa fecha, FP si tiene clase de un módulo de DAM/DAW o Máster si ese día tiene clase de 
máster. 
...
while True:
    if not fecha.isnumeric():
        fecha = input("Tipo de dato incorrecto, intentalo de nuevo: ")
    elif int(fecha) <= 0 or int(fecha) > 31:
        fecha = input("Número incorrecto, intentalo de nuevo: ")
    else:
